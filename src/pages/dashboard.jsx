...
export default function Dashboard() {
    return (
        <div className="bg-[#121212] relative h-screen w-full text-white p-6 flex flex-col overflow-auto">
            <Topbar title="DashBoard" />

            <div className="flex gap-10 h-56 my-5">
                <div className="flex h-56 relative bg-[#0B0B0B] rounded-2xl w-[60%] items-center pl-10 justify-between">
            ...
            <div className="h-full flex gap-10  mt-5 mb-5">
                <EventsAnalysisCard />
